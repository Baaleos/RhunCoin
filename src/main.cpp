...
uint256 hashGenesisBlock("0x00000000444b3b2357cd0a7867060bed97f3dd36073e744ee40260c20512ef36");
...
const string strMessageMagic = "Rhuncoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 310000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 310000);

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 604800;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000000444b3b2357cd0a7867060bed97f3dd36073e744ee40260c20512ef36");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1412180153;
        block.nBits    = 486604799;
        block.nNonce   = 3041638169;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("RhuncoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("RhuncoinMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running RhuncoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("RhuncoinMiner terminated\n");
        throw;
    }
}
